...
if ($_SESSION['user']['vendite'] > "1")
{
    ...
    <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
        ...
        <tr><td><?php
                ...
                $dati = tabella_clienti("singola", $_POST['cliente'], $_parametri);
...
// se risulta bloccato chiudo tutto
                ...
                else
                {
                    ...
                    $query = sprintf("select * from fv_testacalce INNER JOIN clienti ON fv_testacalce.utente = clienti.codice where utente=\"%s\" and anno=\"%s\" and status='stampato' order by suffix, ndoc", $_utente, $_anno);
                    ...
                    foreach ($result AS $dati)
                    {
                        ...
                        printf("<option value=\"%s%s\">%s/%s - %s</option>\n", $dati['suffix'], $dati['ndoc'], $dati['ndoc'], $dati['suffix'], $dati['ragsoc']);
                    }
