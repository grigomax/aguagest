...
// eseguo l'aggiornamento dell'archivio fatture
    ...
    $query = sprintf("UPDATE fv_testacalce SET tdocevaso=\"%s\", evasonum=\"%s\", evasoanno=\"%s\", status='evaso' where ndoc=\"%s\" and anno=\"%s\"", $_tdocevaso, $_evasonum, $_evasoanno, $_nfattura, $_anno);
