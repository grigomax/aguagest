...
// elenca le fatture presenti in archivio non evasi solo ricevuta bancaria
	echo "<span class=\"testo_blu\"><center><br><b>Banca di presentazione ". $_SESSION['banca']['banca'] ."</b></center><br>";
// elenco documenti fatture vendita
	echo "<span class=\"testo_blu\"><center><br><b>Selezionare gli effetti da presentare</b></center><br>";
...
// echo "<td width=\"30\" align=\"center\" class=\"logo\"><span class=\"testo_bianco\">Tipo</span></td>";
	...
	{
		echo "<tr>";
		printf("<form action=\"crea_dist.php\" method=\"POST\">");
