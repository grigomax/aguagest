...
// imposto la sessione della banca
	...
	if ($_azione == "modifica")
	{
		...
		echo "<span class=\"testo_blu\"><center><br><b>Selezionare gli effetti da includere nella distinta</b></center><br>";
		...
		foreach ($result AS $dati)
		{
			...
			printf("<td width=\"80\" align=\"center\"><span class=\"testo_blu\">%s</span></td>", $dati['numeff']);

			if ($dati['ndistinta'] == $_ndistinta)
			{
				printf("<td width=\"80\" align=\"center\"><span class=\"testo_blu\"><input type=\"checkbox\" name=\"check[]\" value=\"%s%s\" valore=\"%s\" checked></span></td>", $dati['annoeff'], $dati['numeff'], $dati['impeff']);
			}
			else
			{
				printf("<td width=\"80\" align=\"center\"><span class=\"testo_blu\"><input type=\"checkbox\" name=\"check[]\" value=\"%s%s\" valore=\"%s\"></span></td>", $dati['annoeff'], $dati['numeff'], $dati['impeff']);
			}
			echo "</tr>";
			echo "<tr>";
