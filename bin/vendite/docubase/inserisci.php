...
//recuperiamo le variabili ambiante
    ...
    if (($_SESSION['utente'] != "") OR ( $_azione == "Spedizione"))
    {
        ...
        {
            $_documento = gestisci_testata("scrivi_spedizione", $_utente, $_tdoc, $_anno, $_suffix, $_ndoc, $_datareg, $_archivi, $_POST);
...
#Inizio parte visiva del documento...-------------------------------------------
        ...
        echo "<a href=\"visualizzadoc.php?tdoc=$_documento[tdoc]&ndoc=$_documento[ndoc]&anno=$_documento[anno]&suffix=$_documento[suffix]\">Clikka qui e vai subito!</a>\n";
        echo "</center>";
