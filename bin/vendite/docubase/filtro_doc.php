...
#mi prendo i documenti
	...
	else
	{
		...
		echo "<tr><td colspan=\"9\" align=\"center\" valign=\"top\">";
		...
		echo "<td align=center colspan=\"4\"><input type=\"radio\" name=\"start\" value=\"$_start\" checked>Elenco $_start disponibili</td></tr>";
		...
		{
			echo "<tr>";
			printf("<td width=\"30\" align=\"center\"><input type=\"checkbox\" name=\"numero[]\" value=\"%s%s\"></td>\n", $dati_start['anno'], $dati_start['ndoc']);
			printf("<td width=\"80\" align=\"center\"><span class=\"testo_blu\">%s</span></td>", $dati_start['datareg']);
			printf("<td width=\"80\" align=\"center\"><span class=\"testo_blu\"><b>%s</b></span></td>", $dati_start['ndoc']);
			printf("<td style=\"height: 1.5em;\" align=\"left\"><span class=\"testo_blu\">%s</span></td>", $dati_start['ragsoc']);
			printf("<td width=\"50\" align=\"center\"><span class=\"testo_blu\">%s</span></td>", $dati_start['status']);
			printf("<td width=\"50\" align=\"center\"><span class=\"testo_blu\">%s</span></td>", $dati_start['totimpo']);
			echo "<td width=\"30\" align=\"center\"><input type=\"checkbox\" name=\"righe$dati_start[anno]$dati_start[ndoc]\" value=\"SI\" checked></td>\n";

			if (($_start == "conferma") OR ($_start == "fornitore"))
			{
				if($dati_start['status'] == "parziale")
				{
					echo "<td width=\"30\" align=\"center\"><input type=\"radio\" name=\"tipologia$dati_start[anno]$dati_start[ndoc]\" value=\"parz\" checked></td>\n";
					echo "<td width=\"30\" align=\"center\"><input type=\"radio\" name=\"tipologia$dati_start[anno]$dati_start[ndoc]\" value=\"totale\"></td>\n";
				}
				else
				{
					echo "<td width=\"30\" align=\"center\"><input type=\"radio\" name=\"tipologia$dati_start[anno]$dati_start[ndoc]\" value=\"parz\"></td>\n";
					echo "<td width=\"30\" align=\"center\"><input type=\"radio\" name=\"tipologia$dati_start[anno]$dati_start[ndoc]\" value=\"totale\" checked ></td>\n";
				}
		...
		if ($_end == "ddtacq")
		{
			...
			echo "<tr><td align=\"center\" colspan=\"9\" valign=\"top\"><br>N. ddt Fornitore: <input type=\"text\" name=\"ddtfornitore\" size=\"20\" maxlength=\"20\">\n";
		...
		$_ndoc = seleziona_documento("ultimo_numero", $_end, $_anno, $_suffix, $_ndoc, $_archivio_end, $_parametri);
		//$_ndoc = ultimo_documento($_end, $_anno);

		$_datareg = date("d-m-Y");

		echo "<tr><td align=\"center\" colspan=\"9\"><br><input type=\"radio\" name=\"end\" value=\"$_end\" checked>Documento da creare = $_end </td></tr>\n";
		printf("<tr><td align=\"center\" colspan=\"9\">Numero Documento<input type=\"number\" name=\"ndoc\" size=\"10\" value=\"%s\" required> Anno <input type=\"number\" name=\"anno\" size=\"10\" value=\"%s\" required>", $_ndoc, $_anno);

		echo " Data <input type=\"text\" class=\"data\"  size=\"12\" name=\"datareg\" value=\"$_datareg\"></td></tr>\n";

		if (($_end == "FATTURA") OR ($_end == $nomedoc))
		{
			echo "<tr><td align=\"center\" colspan=\"9\"><br>Eventuali spese Bancarie <input type=\"text\" name=\"speseb\" size=\"6\" value=\"0.00\"> </td></tr>";
		}
