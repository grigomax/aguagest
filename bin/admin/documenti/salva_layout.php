...
//
    ...
    '$_POST[ST_TLOGO]', '$_POST[ST_FONTOLOGO]', '$_POST[ST_FONTLOGOSIZE]', '$_POST[ST_TIPOTESTATA]',
...
// aggiorniamo i dati nel database..
    ...
    ST_TLOGO = '$_POST[ST_TLOGO]', ST_FONTOLOGO = '$_POST[ST_FONTOLOGO]', ST_FONTLOGOSIZE = '$_POST[ST_FONTLOGOSIZE]', ST_TIPOTESTATA = '$_POST[ST_TIPOTESTATA]',
