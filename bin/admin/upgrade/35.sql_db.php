...
echo "<h4>Inizio aggiornamento archivi versione 35</h4>\n";


//eliminazione archivio aaa

$query = "ALTER TABLE co_dettaglio CHANGE qtaevasa qtaevasa FLOAT( 16, 2 ) NULL DEFAULT '0.00',
...
{
	echo "Alterazione tabella co_dettaglio agg. 35 punto 1.........  riuscita perfettamente <br>";
	$_num++;
	$fine = 1;
}
else
{
	echo "Alterazione tabella co_dettaglio agg. 35 punto 1 $db_nomedb<br>";
