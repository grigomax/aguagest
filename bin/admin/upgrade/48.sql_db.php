...
/* AGGIORNAMENTO TABELLE DATABASE AL 05/09/2015
 * Aggiornamento tabella contabilita lunghezza registrazione
 * 
 */

echo "<h4>Inizio aggiornamento archivi versione 48</h4>\n";

$_versione = "48";
$_punto = "0";

$query = "ALTER TABLE prima_nota CHANGE desc_conto desc_conto VARCHAR( 100 ) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'descrizione conto'";

$conn->exec($query);
$_punto++;
if ($conn->errorCode() == "00000") // ... tutto ok
{
    echo "Alterazione prima nota descrizione. $_versione punto $_punto ..  riuscita perfettamente <br>";
    $_num++;
    $fine = 1;
}
else
...
$query = "ALTER TABLE prima_nota_basket CHANGE descrizione descrizione VARCHAR( 100 ) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'descrizione operazione'";
