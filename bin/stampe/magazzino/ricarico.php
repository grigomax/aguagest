	...
	<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
		<tr>
			<td width="85%" align="center" valign="top">
				<span class="intestazione"><h2>Stampa differenze di magazzino</h2><br><b>Scegliere il periodo di riferimento</b></span><br>
			</td></tr>
		<?php

		printf("<form action=\"rp_ricarico.php\" target=\"sotto\" method=\"POST\">");

                
                
                echo "<tr><td align=center>";
                //elenchiamo gli anni presenti..
