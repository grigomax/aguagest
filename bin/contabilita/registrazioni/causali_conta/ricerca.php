...
if ($_SESSION['user']['contabilita'] > "1")
{
    ...
    echo "<option value=\"causale\">Codice causale </option>\n";
    echo "<option value=\"conto_dare\">codice conto in dare</option>\n";
    echo "<option value=\"conto_avere\">codice conto in avere</option>\n";
