...
if(isset($_GET["textdim"])) $textdim=$_GET["textdim"];
...
switch ($type)
{
        default:
                $type = 1;
        case 1:
                Barcode39 ($barcode, $width, $height, $quality, $format, $text, $textdim);
                break;          
}
...
//-----------------------------------------------------------------------------
function Barcode39 ($barcode, $width, $height, $quality, $format, $text, $textdim)
{
        switch ($format)
        {
                default:
